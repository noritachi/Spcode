...
***/
    ...
    <body onload="">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-dark fixed-top">
            <a class="navbar-brand text-white" href="#">SPCODE</a>
            ...
            <div class="row">
                ...
                <div class="col-sm-2 col-md-2 sidebar badge-dark" style="margin:inherit;" id="sidebar">
                    <ul class="list-group text-white sidebar-list">
                        ...
                        <li class="list-group-item bg-dark "><a href="manage_courses/manage_courses.php">Manage
                                Courses</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane container active" id="home">
                            <div class="card-header mt-3 mr-5 bg-white text-info border-0 shadow card1 text-center"
                                style="width: 1050px; box-shadow: 1px 1px 1px 1px #ccc"><b class="text-center">YOUR
                                    ONLINE QUIZE COURSES</b></div><br>
                                            ...
                                            <div class="tab-pane fade show active p-3" id="one" role="tabpanel"
                                                ...
                                                <div class="card-body col-md-12">
                                                    ...
                                                    <div class="card" style="box-shadow: 2px 2px 2px 2px #dfdfdf;">
                                                        <div class="card-header bg-success text-light p-2 cardh2">
