        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <h1 style="color: white;margin-top: 10px;" id="myhead">
                        <a style="color: white;text-decoration: null;" href="/spcode">SPCODE</a>
                    </h1>
                </div>
                <div class="collapse navbar-collapse" id="navi">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li> <a href="" id="our-location" class="btn-success"><?php echo $_SESSION['username']; ?></a>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 content-border" style="margin-bottom: 10px;">
                    <div class="latest-news-wrap">
                        ...
                        <div class="news-content">
                            ...
                            <a
                                href="programming/java/java_programming.php?course_name=<?php echo $res['language_name'] ?>">Start
                                Reading...</a>
                        </div>
                    </div>
                </div>
